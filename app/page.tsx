  ...
  return (
    <div className="min-h-screen">
      <AppHeader
        ...
        actions={
          <div className="flex items-center gap-1">
            <button type="button" onClick={() => { window.location.href = "/settings"; }} className="rounded-full p-2 text-white/80 transition-colors hover:bg-white/15 hover:text-white active:scale-95" title="Settings">
            ...
            <button type="button" onClick={() => { window.location.href = "/admin"; }} className="rounded-full p-2 text-white/80 transition-colors hover:bg-white/15 hover:text-white active:scale-95" title="Admin">
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
              </svg>
            </button>
            <button type="button" onClick={() => void signOut({ callbackUrl: "/login" })} className="rounded-full p-2 text-white/80 transition-colors hover:bg-white/15 hover:text-white active:scale-95" title="Sign out">
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <main className="mx-auto max-w-6xl px-6 py-8">
        {/* Hero.
            The blurred circles that used to fill this space were generic
            decoration; the Pacific pattern is the identity's own answer to a
            large empty field, and this is where it can run at full strength
            because nothing here competes with it. */}
        <BrandField
          variant="hero"
          className="rounded-[var(--radius-2xl)] p-12 text-white"
        >
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              },
              {
                ...
                prompt: "Create a trade dashboard comparing imports and exports across Pacific Island countries",
