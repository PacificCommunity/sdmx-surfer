...
export const config = {
  matcher: [
    "/((?!api/auth|api/public|api/sdmx-proxy|api/countrysnapshots|countrysnapshots|api/training|training(?:/|$)|_next/static|_next/image|favicon.ico|models/|brand/|login|gallery(?:/|$)|p(?:/|$)).*)",
  ],
};
